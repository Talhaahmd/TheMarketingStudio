...
const HERO_LINKS = [
    ...
    { label: "AI UGC", href: "#" },
    { label: "Meta & Google Ads", href: "#" },
    { label: "AI Content & SEO", href: "#" },
];
                ...
                <div className="row g-4 align-items-end">
                    <div className="col-lg-5 pt-lg-0 pt-100">
                        <div className="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span className="text-uppercase neutral-900 fw-600">
                                ...
                                <span className="text-1 neutral-500"> AI Marketing</span>
                            </span>
                        </div>
                        <h1 className="section-title d-flex fw-600 reveal-text mb-40 text-nowrap">
                            <RevealText>AI Marketing</RevealText>
                        </h1>
                    ...
                    <div className="col-lg-5 ms-auto">
                        <h6 className="fw-600 reveal-text mb-0">
                            <RevealText>
                                From motion graphics and UGC content to Meta Ads, Google Ads, AI content, and SEO — each service is built around a specific outcome for your business, not just deliverables.
                            </RevealText>
                        </h6>
                    </div>
                </div>
