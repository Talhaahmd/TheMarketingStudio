...
const ITEMS = [
    {
        ...
        description: "AI-assisted motion graphics and 2D animations that communicate your brand story with clarity, emotion, and scroll-stopping impact.",
    },
    {
        icon: ICON_2,
        title: "AI UGC & Video Content",
        description: "AI-generated UGC-style videos that look authentic, perform like organic content, and scale your creative output without ballooning production costs.",
    },
    {
        icon: ICON_3,
        title: "Meta & Google Paid Ads",
        description: "Full-funnel paid advertising on Meta and Google — from AI-optimised creative to audience targeting, bid strategy, and ROAS-focused scaling.",
    },
    {
        icon: ICON_4,
        title: "AI Content & SEO",
        description: "AI-powered content strategies and SEO campaigns that drive compounding organic traffic, build topical authority, and convert visitors into leads.",
    },
];
                ...
                <div className="row">
                    <div className="col-lg-5 h-100">
                        ...
                        <h3 className="reveal-text mb-40">
                            <RevealText>
                                Four services, one team, one integrated strategy.
                            </RevealText>
                        </h3>
                        <h6 className="fw-600 mb-0">
                            Each service at STRATX is built to work independently or together — so whether you need motion content, paid ads, organic search, or all three, the strategy stays connected.
                        </h6>
