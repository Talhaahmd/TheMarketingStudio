...
const STEPS = [
    {
        num: "01",
        title: "Discover",
        description: "Audit your brand, goals, and market to find the highest-leverage growth opportunities",
    ...
    },
    {
        num: "02",
        title: "Create",
        description: "Produce AI-powered motion graphics, UGC content, and ad creatives built to convert",
    ...
    },
    {
        num: "03",
        title: "Launch",
        description: "Deploy campaigns on Meta and Google with AI bidding, precise targeting, and A/B testing",
    ...
    },
    {
        num: "04",
        title: "Scale",
        description: "Identify winners, reinvest budget into top performers, and compound your growth",
                ...
                <div className="row g-4">
                    <div className="col-lg-6">
                        ...
                        <h3 className="reveal-text mb-20">
                            <RevealText>How we deliver AI-powered growth</RevealText>
                        </h3>
                        <h6 className="fw-500 mb-0">
                            We combine AI tools, paid media expertise, and creative production into a clear four-step growth framework.
                        </h6>
                    </div>
