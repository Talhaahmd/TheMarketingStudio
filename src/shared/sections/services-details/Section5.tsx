...
const RECEIVE_ITEMS = [
    "AI-optimised ad creatives",
    "Motion graphics & UGC videos",
                    ...
                    <div className="row g-4 align-items-center">
                        ...
                        <div className="col-lg-5 mx-auto">
                            ...
                            <h4 className="reveal-text mb-0 fw-600 pe-lg-5">
                                <RevealText>
                                    Everything you need to launch, optimise, and scale AI-powered marketing campaigns.
                                </RevealText>
                            </h4>
                            ...
                            <div className="testimonial-author d-flex align-items-start mb-0 gap-4">
                                ...
                                <div className="testimonial-content">
                                    <p className="fz-xl neutral-900 fw-400">
                                        &quot;STRATX took our Meta ads from a 1.2x ROAS to 4.2x in 60 days. The motion content they produced looked better than anything our in-house team had created, and the AI-driven targeting was a game changer.&quot;
                                    </p>
