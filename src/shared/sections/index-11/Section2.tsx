                ...
                <div className="row g-4">
                    <div className="col-xxl-4 col-lg-8 col-12">
                        ...
                        <h4 className="h5 fw-600 reveal-text pe-xxl-5">
                            <RevealText>STRATX combines creative production, paid media, and AI-assisted workflows so brands can launch faster, test smarter, and keep what works.</RevealText>
                        </h4>
                    </div>
