...
const TEAM_MEMBERS = [
    {
        nameFirst: "Paid Ads",
        nameLast: "Strategist",
        role: "Meta Ads · Google Ads · Campaign Testing",
    ...
    },
    {
        nameFirst: "Motion",
        nameLast: "Designer",
        role: "Motion Graphics · Brand Film · Social Ads",
    ...
    },
    {
        nameFirst: "Content",
        nameLast: "Strategist",
        role: "UGC Concepts · Scripts · AI Content Direction",
    ...
    },
    {
        nameFirst: "SEO",
        nameLast: "Specialist",
        role: "Keyword Planning · Technical SEO · Organic Growth",
                ...
                <div className="sec-6-home-10__layout">
                    <header className="sec-6-home-10__title-block">
                        ...
                        <h2 className="sec-6-home-10__title mt-3 mb-0 at_fade_anim reveal-text" data-delay="0.08">
                            <RevealText>The STRATX Team</RevealText>
                        </h2>
                    </header>
                    ...
                    <div className="sec-6-home-10__foot at_fade_anim" data-delay="0.18">
                        <p className="sec-6-home-10__foot-text mb-0 reveal-text">
                            <RevealText>A focused team of strategists, editors, designers, ad specialists, and SEO experts who turn ideas into measurable marketing systems.</RevealText>
                        </p>
                        <Link
