...
const PROCESS_STEPS = [
    {
        ...
        desc: "We study your brand, audience, competitors, and current performance to find the strongest growth opportunities.",
        delay: ".3",
    },
    {
        num: "02",
        title: "Creative Strategy",
        desc: "We define campaign angles, content themes, hooks, visual direction, and platform-specific execution plans.",
        delay: ".37",
    },
    {
        num: "03",
        title: "Production & Launch",
        desc: "Motion graphics, UGC-style creatives, SEO assets, and ad copy — produced and launched across the right channels.",
        delay: ".44",
    },
    {
        num: "04",
        title: "Test, Optimise & Scale",
        desc: "We track results, improve creative, adjust targeting, and redirect budget to what shows the strongest return.",
        delay: ".51",
    },
];

const STATS = [
    { count: 5, suffix: "+", label: "Years in market", delay: ".1" },
    { count: 150, suffix: "+", label: "Projects delivered", delay: ".16" },
    { count: 3, suffix: "x", label: "Avg. return on ad spend", delay: ".22" },
    { count: 90, suffix: "%", label: "Long-term clients", delay: ".28" },
];
                ...
                <div className="row align-items-end">
                    ...
                    <div className="col-lg-5">
                        <p className="mb-0 at_fade_anim" data-delay=".25" data-fade-from="right">
                            STRATX is built for brands that need more than content. We combine creative production, paid media, SEO, analytics, and AI-assisted workflows to help businesses create campaigns faster, test smarter, and scale what works — across Toronto, Lahore, and global markets.
                        </p>
                    </div>
                </div>
                ...
                <div className="sec-3-home-11__grid row g-4 g-xl-5 mt-5">
                    ...
                    <div className="col-lg-5">
                        <div className="sec-3-home-11__media-a at_fade_anim" data-delay=".1" data-fade-from="left">
                            ...
                            <div className="sec-3-home-11__metric" aria-label="150+ campaigns delivered">
                    ...
                    <div className="col-lg-4">
                        <div className="sec-3-home-11__content">
                            <p className="sec-3-home-11__body at_fade_anim" data-delay=".2" data-fade-from="bottom">
                                We don't separate creative from performance. Every piece of content, every ad, and every SEO asset is built with a clear outcome in mind — more reach, lower cost per lead, or higher revenue.
                            </p>
                        ...
                        <div className="sec-3-home-11__side at_fade_anim" data-delay=".15" data-fade-from="right">
                            ...
                            <blockquote className="sec-3-home-11__quote at_fade_anim" data-delay=".42" data-fade-from="bottom">
                                <p className="sec-3-home-11__quote-text mb-2">
                                    &ldquo;Creative without strategy is just art. We make it both.&rdquo;
                                </p>
