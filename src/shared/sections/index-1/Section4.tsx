...
const SERVICES = [
    { num: "01", title: "Motion Design", text: "AI-powered motion graphics and brand videos that stop the scroll and build brand equity.", thumb: "/assets/imgs/pages/img-5-sm.webp" },
    { num: "02", title: "Branding", text: "Brand identity, messaging, and visual systems built to position you as the authority in your market.", thumb: "/assets/imgs/pages/img-6-sm.webp" },
    { num: "03", title: "AI UGC", text: "AI-generated UGC-style video content that looks authentic, converts at scale, and costs a fraction of traditional production.", thumb: "/assets/imgs/pages/img-7-sm.webp" },
    { num: "04", title: "2D Animations", text: "Explainer videos, product demos, and social-first 2D animations that communicate complex ideas with clarity.", thumb: "/assets/imgs/pages/img-8-sm.webp" },
    { num: "05", title: "Paid Advertisements", text: "AI-optimised Meta and Google ad campaigns — from creative production to targeting, bidding, and scaling.", thumb: "/assets/imgs/pages/img-9-sm.webp" },
    { num: "06", title: "Graphic Design", text: "High-impact ad creatives, social graphics, and brand assets designed to perform in a competitive feed.", thumb: "/assets/imgs/pages/img-10-sm.webp" },
];
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="at-service-subtitle-wrap at-about-border d-flex justify-content-between gap-3 mb-50">
                            ...
                            <span className="fs-font-md fw-500 text-decoration-underline">Since 2019</span>
                        </div>
                    </div>
