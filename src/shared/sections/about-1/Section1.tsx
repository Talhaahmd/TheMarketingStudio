                ...
                <div className="row align-items-center g-4">
                    ...
                    <div className="col-lg-7 h-100">
                        <h2 className="section-title fw-600 lh-1 reveal-text">
                            <RevealText>
                                The AI Marketing Studio Behind Brands That Convert
                            </RevealText>
                        </h2>
                    </div>
                    <div className="col-lg-5 ms-auto">
                        <h6 className="mb-4 fw-600">
                            STRATX is an AI Marketing Studio in Toronto and Lahore. We help brands grow through motion graphics, UGC content, Meta Ads, Google Ads, AI content, and SEO — all managed under one team, one strategy, one process.
                        </h6>
