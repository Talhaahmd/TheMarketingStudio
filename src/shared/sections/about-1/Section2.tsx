...
const JOURNEY_ITEMS = [
    {
        date: "2019 — The Beginning",
        title: "STRATX is Founded",
        company: null,
        desc: "Started as a lean creative studio focused on video content and motion graphics for small brands. Built our first reel of clients across Toronto and Lahore.",
    },
    {
        date: "2021 — Going AI-First",
        title: "Embracing Artificial Intelligence",
        company: null,
        desc: "We integrated AI tools into every part of our workflow — from content ideation to creative production — cutting costs and accelerating output without sacrificing quality.",
    },
    {
        date: "2022 — Paid Ads Expansion",
        title: "Meta & Google Ads Practice Launched",
        company: null,
        desc: "We expanded into performance marketing, managing Meta and Google ad campaigns for e-commerce brands. Our AI-generated creatives outperformed industry benchmarks by 2–3x.",
    },
    {
        date: "2024+ — Full-Stack Growth Studio",
        title: "The AI Marketing Studio Vision",
        company: null,
        desc: "Today, STRATX is a full-stack AI Marketing Studio — combining motion graphics, UGC content, paid ads, SEO, and strategy under one roof for ambitious brands worldwide.",
    },
];
                ...
                <div className="row align-items-end pb-60">
                    <div className="col-lg-7 col-md-7">
                        ...
                        <p className="text-white fz-font-lg">
                            From a motion graphics studio in 2019 to a full-service AI Marketing Studio serving brands globally. Here is how STRATX evolved.
                        </p>
                    </div>
                                ...
                                <div className="alt-portfolio-btn">
                                    <div className="content">
                                        ...
                                        <p className="text-white fz-font-md mb-0 mt-10 text-truncate-2 des">
                                            Motion graphics, paid ads, AI content and SEO under one roof
                                        </p>
                                    </div>
                                </div>
                            </Link>
