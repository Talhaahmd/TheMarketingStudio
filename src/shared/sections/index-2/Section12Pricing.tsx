...
const PERSONAL_PRICES = { starter: "$497", growth: "$997", scale: "$1,997" };
const BUSINESS_PRICES = { starter: "$797", growth: "$1,497", scale: "$2,997" };
...
const PLANS = [
    {
        ...
        desc: "Perfect for brands just starting with AI-powered marketing and paid ads.",
        btnText: "Get Started",
        features: [
            "1 ad platform (Meta or Google)",
            "4 AI ad creatives/month",
    ...
    },
    {
        ...
        desc: "For brands ready to scale with multi-channel AI marketing and content.",
        btnText: "Choose Growth",
        features: [
            "Meta Ads + Google Ads",
            "8 AI creatives + 4 UGC videos/month",
            "SEO content (4 posts/month)",
    ...
    },
    {
        ...
        desc: "Full-stack AI marketing for ambitious brands serious about growth.",
        btnText: "Scale Your Brand",
        features: [
            "Meta + Google + full-funnel strategy",
            "Unlimited AI creatives & UGC",
            "SEO content (8 posts/month)",
