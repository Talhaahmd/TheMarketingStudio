          ...
          <div className="row align-items-center">
              ...
              <div className="at-header-logo">
                <Link to="/" className="d-inline-flex align-items-center gap-2 text-decoration-none">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M2 14L14 2L26 14" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M6 14L14 6L22 14" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.6"/>
                  </svg>
                  <h6 className="fw-700 fz-24 text-white mb-0">STRATX</h6>
                </Link>
              </div>
            </div>
            ...
            <div className="col-xl-2 col-6">
              <div className="at-header-right gap-3 d-flex justify-content-end align-items-center">
                <NavLink
                  to="/contact"
                  className="at-btn-lets-talk text-white fw-500 fz-14 px-4 py-2 rounded-pill border border-white border-opacity-50 text-decoration-none"
